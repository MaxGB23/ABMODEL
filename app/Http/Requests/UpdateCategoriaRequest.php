...
class UpdateCategoriaRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'descripcion.regex' => 'El campo "descripción" solo puede contener letras, números, espacios, puntos, comas y guiones.',
        ];
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'categoria' => [
                ...
                'unique:categorias,categoria,' . $categoriaId, // Debe ser único en la tabla 'categorias' (opcional)
            ],
