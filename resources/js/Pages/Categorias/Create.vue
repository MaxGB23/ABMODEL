...
<template>
    ...
    <div class="max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:mx-32 mx-auto">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 ml-6">
            <h2 class="text-2xl sm:text-3xl font-semibold text-gray-200 mb-4 sm:mb-0">Crear Nueva Categoría</h2>
        </div>
            ...
            <form @submit.prevent="createCategoria">
                ...
                <div class="mb-4">
                    ...
                    <textarea v-model="form.descripcion" id="descripcion" rows="4"
                        ...
                        :class="{'text-white focus:ring-red-400 focus:border-red-400 border-red-300' : form.errors.descripcion}">
                        </textarea>
                    <InputError
