...
export default {
    ...
    computed: {
        logoUrl() {
            return `${window.location.origin}/images/faq.gif`;
        },
    }
};
</script>
...
.faq-container {
    ...
    max-width: 1200px;
    /* Limitar el ancho total del contenedor */
    margin: 0 auto;
    flex-wrap: wrap;
...
.faq-list {
    max-width: 600px;
    /* Limitar el ancho de la lista de FAQ */
    text-align: left;
    flex: 1;
    /* Permitir que la lista tome el espacio disponible */
}
